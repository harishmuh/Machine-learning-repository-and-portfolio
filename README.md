...
| **COVID-19 Positivity Prediction** | Modeled 280.000 patient test results (data from the ministry of health) to predict COVID-19 positivity | `Recall`, `PR-AUC`, `Classification`, `Permutation Importance`, `LIME` | [🔗 View Repo](https://github.com/harishmuh/COVID19_Prediction/tree/main)) |
---
